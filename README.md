<b>XStepBot - bot, developed by DMIT Computers.</b> Based on DMIT Computers Bot source code version 3.1.1.
...
<p>I'm sorry, existing only Russian version. Although no one bothers, change the loclaization, improve the code.
